...
/*
  ...
  4. 지도 코드 작성
    ...
    6.아이콘 구하기
    7.다른이미지로 마커 생성하기 : https://apis.map.kakao.com/web/sample/basicMarkerImage/
8.위치값 데이터
[
  {
    title:"1호점",
...
const Location = () => {
  ...
  const options = {
    //지도를 생성할 때 필요한 기본 옵션
    center: new kakao.maps.LatLng(35.868368, 128.594107), //지도의 중심좌표.
  ...
  useEffect(() => {
    ...
    // 마커가 표시될 위치입니다
    const markerPosition = new kakao.maps.LatLng(35.868368, 128.594107);
